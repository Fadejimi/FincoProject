...
import com.bank.app.BankController;
import com.creditcard.app.CardController;
import com.finco.framework.AbstractCustomerDialog;



public class JDialog_AddCard extends AbstractCustomerDialog
{
    private CardFrm parentframe;
    private CardController controller;
    
	public JDialog_AddCard(CardFrm parent, CardController controller)
	{
	...
	{
       controller.setAccountnr(JTextField_CCNR.getText());
       ...
       controller.setEmail(JTextField_Email.getText());
       controller.setExpiryDate(JTextField_ExpDate.getText());
       
       if (JRadioButton_Gold.isSelected()) {
    	   		controller.setAccountType("gold");
       }
       else if (JRadioButton_Silver.isSelected()){
    	   		controller.setAccountType("silver");
       }
       else {
    	   		controller.setAccountType("bronze");
       }
