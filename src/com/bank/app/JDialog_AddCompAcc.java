...
public class JDialog_AddCompAcc extends AbstractCustomerDialog
{
	...
	public JDialog_AddCompAcc(BankFrm parent, BankController controller)
	{
	...
	{
       controller.setAccnr(JTextField_ACNR.getText());
       ...
       controller.setNoEmployees(JTextField_NoOfEmp.getText());
